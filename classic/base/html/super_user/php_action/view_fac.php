        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Email:</label>
                        <p class="form-control-static"><?php echo $row["facEmail"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Password:</label>
                        <p class="form-control-static"><?php echo $row["facPass"]; ?></p>
                    </div>
                    <p><a href="../faculty_account.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
