            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["studOrg"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Position:</label>
                        <p class="form-control-static"><?php echo $row["studPosition"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
                        <p class="form-control-static"><?php echo $row["studEmail"]; ?></p>
                    </div>
                    <div class="form-group">
