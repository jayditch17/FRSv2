...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Reservation | Super User</title>
    ...
    <div class="page">
      <div class="page-content container-fluid">
        <div class="row" data-plugin="matchHeight" data-by-row="true">
                    ...
                    $sql = "SELECT * FROM events Where color ='#787878' and expire >= CURDATE()";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['endTime'] . "</td>";
                                         echo "<td><a href='accept_reser.php?eventID=". $row['eventID'] ."' title='Delete Record' data-toggle='tooltip' class='btn btn-success'>Accept</a></td>";
                                        echo "<td><a href='php_action/reject.php?eventID=". $row['eventID'] ."' title='Update Record' data-toggle='tooltip' class='btn btn-danger'>Reject</a></td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                            echo "</table>";
